...
** Working with tags
   ...
   So it is a missing file? https://emacs.stackexchange.com/questions/17048/how-to-add-a-directory-to-the-org-agenda-files
...
** How to make spacema
*** cs split window right automatically?
