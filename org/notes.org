...
** Run the install files in this order
   ...
   The repository will now contain the latest version of git but the package information will still show the default version.
...
=======
   I still need to use stow but I might as well have it on the system.
>>>>>>> b5e950bd177f49a99280ab3bed8922c3718f6703
   apt-get -y update
